...
**Domarium** is a marketplace for house construction and cost estimation. It is designed for construction customers, designers, and contractors and turns future-home parameters into a structured proposal and a clear estimate.

- Public URL: https://domarium.botsaray.ru/
- Core entities: projects, rooms, specifications, stages, estimate items, proposals, and contractors.
- Key capabilities: house parameters, room details, stage specifications, cost estimate, solution catalog, proposal comparison, cost breakdown.

## Why the Product Is Needed

A real workflow rarely consists of a single action. Users must understand the initial situation, gather information, choose the next step, coordinate a decision, and return to the result later. Domarium provides one domain-specific environment for this work. It preserves context between stages and shows not only an individual item, but also its place in the overall process.

The product’s main value is not the number of screens, but workflow continuity. Projects, rooms, specifications, stages, estimate items, proposals, and contractors are treated as parts of one user journey. New participants understand the current state faster, experienced specialists spend less time matching information manually, and managers gain a clear overview without requiring every step to be retold.
...
The roles Customer, Estimator, and Contractor work with the same domain model from different perspectives. Consistent names for objects and states reduce ambiguity during handoffs. A responsible participant can reference a specific object and expected result instead of repeating the entire context.

## Main Sections

The public description covers these user capabilities:

- **House parameters** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Room details** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Stage specifications** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Cost estimate** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Solution catalog** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Proposal comparison** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Cost breakdown** — a distinct part of the workflow, connected to the product model and a clear user outcome.
...
### 01 room details
![01 room details](docs/screenshots/01-detalizaciya-pomeshchenij.jpg)

### 02 stage specifications and estimate
![02 stage specifications and estimate](docs/screenshots/02-harakteristiki-i-smeta-etapov.jpg)

### 03 catalog and service information
![03 catalog and service information](docs/screenshots/03-katalog-i-o-servise.jpg)
